...
\begin{figure}[htbp]
    ...
    \begin{tabular}{ccc}
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{Groudnwater reservoir\\(annual mean, \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/slowr_subgrid.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{Groudnwater reservoir\\(annual mean, \native)}
            \includegraphics[width=\linewidth]{images/chap3/maps/slowr_interp.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{Groudnwater reservoir (difference, \native - \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/slowr_diff.png}
        \end{subfigure} \\
        
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{Surface water reservoir\\(annual mean, \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/fastr_subgrid.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{Surface water reservoir\\(annual mean, \native)}
            \includegraphics[width=\linewidth]{images/chap3/maps/fastr_interp.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{Surface water reservoir (difference, \native - \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/fastr_diff.png}
        \end{subfigure} \\
        
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{River reservoir\\(annual mean, \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/streamr_subgrid.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{River reservoir\\(annual mean, \native)}
            \includegraphics[width=\linewidth]{images/chap3/maps/streamr_interp.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{River reservoir (difference, \native - \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/streamr_diff.png}
        \end{subfigure} \\
        
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{River discharge\\(annual mean, \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/hydrographs_subgrid.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{River discharge\\(annual mean, \native)}
            \includegraphics[width=\linewidth]{images/chap3/maps/hydrographs_interp.png}
        \end{subfigure} &
        \begin{subfigure}[b]{0.33\textwidth}
            \caption{River dsicharge (difference, \native - \std)}
            \includegraphics[width=\linewidth]{images/chap3/maps/hydrographs_diff.png}
        \end{subfigure} \\
    \end{tabular}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{images/chap3/river_discharge/halfdeg_4stations_SC.png}
