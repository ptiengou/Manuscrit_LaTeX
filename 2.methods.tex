...
Section \ref{sec:ORCHIDEE} first presents the version of the ORCHIDEE LSM used, with a special focus on the most relevant processes for this work such as the water and energy budgets, river routing and irrigation. ORCHIDEE was used as a stand-alone LSM in Chapter \ref{chap:routing} and in coupled regional simulations with ICOLMDZ for \atmchapters. 
Section \ref{sec:ICOLMDZLAM} describes the ICOLMDZ LAM, as well as the simulations setups used for these coupled simulations. 
...
Since simulations with the LAM only cover a portion of the globe, lateral boundary conditions are read by the model from a forcing file, which can be obtained from various sources of different spatial resolution and sampling frequency. 

%todo:improve with refs : Denis 2003, Wu 2005, Koltzow 2011, Rocheta 2017
...
\begin{table}[h]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|l|l|l|l|l|l|l|l|}
            ...
            \hline
            \ref{sec:article1} & \irr & 2010-2022 & 1500km & 60 & ERA5, 1h & Yes \\
            \hline
...
%todo:adapt to section relocation
