...
To characterize vegetation, ORCHIDEE 2.2 defines 15 plant functional types (PFTs), each associated with a set of characteristic parameters used to compute their average height, leaf area index (LAI), and albedo. 
