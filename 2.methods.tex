...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{images/LAM_domain_zones.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{images/routing_structure.png}
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=0.5\textwidth]{images/methods/altitude_map.png}
