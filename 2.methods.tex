...
ICOLMDZ, the atmospheric component of the model is the association of the dynamical core DYNAMICO \citep{dubos_dynamico-10_2015}, and the LMDZ6A physics used for CMIP6 \citep{hourdin_lmdz6a_2020}. %todo:checker que j'ai bien fait la distinction dynamique/physique en intro
...
\begin{itemize}
    ...
    \item %todo:orographie sous maille
\end{itemize}
...
In the transition zone, the value of $\tau$ is gradually increased over the 8 grid cells, following an arctan profile to smooth the transition, starting from $\tau = 3600$ s on the outer edge. %todo:ajouter valeur au centre suite à réponse Mattermost
