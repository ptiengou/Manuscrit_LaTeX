...
\begin{figure}[ht]
    ...
    \caption{Operating principles of the \textit{interp\_topo} routing}%todo:explain hydrographs
...
\section{Input data and external forcings}
%todo: decide if this is a good way to treat the topic
%topography ? (if not in general intro over Peninsula)
%irrgmap
%aei_sw
%DEMs
%
