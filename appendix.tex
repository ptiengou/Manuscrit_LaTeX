...
\begin{figure}[htbp]
    ...
    \begin{tabular}{ccc}
        ...
        \end{subfigure}
    \end{tabular}
    \caption{Precipitation (a-c) and evapotranspiration (d-f) relative biases compared to ERA5 over 2010-2014 for three simulations with small, intermediate and large domain sizes.}
...
\begin{figure}[hbtp]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure} \\
    \end{tabular}
    \caption{Evolution of 2-m temperature (a-b), 2-m specific humidity (c-d), 10-m wind speed (e-f) and direction (g-h) at Els Plans on 15 and 20 July.}
