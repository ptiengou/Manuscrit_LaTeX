...
\begin{figure}[htbp]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure} \\
    \end{tabular}
    \caption{Impacts of irrigation under climate change. Annual mean relative difference (\futirr - \futnoirr, 2050-2062), in complement of Fig. \ref{fig:diffmaps_future_irr} which showed absolute differences.}
...
\begin{figure}[hbtp]
    ...
    \caption{Vertical wind profiles at 12UTC on 15 and 20 July, at (a-d) La Cendrosa and (e-h) Els Plans.  Additional orange lines show the mean profile for the minimum (dotted) and maximum (dashed) sensible heat fux sub-samples defined in Section \ref{sec:heterogeneities} (first and last two bins on Fig. \ref{fig:sens_bins}).}
