...
\begin{titlepage}
    ...
    \resizebox{\textwidth}{!}{
    \begin{tabular}{@{}ll@{}}
        {\large\bfseries Fabienne LOHOU},       \normalsize Professeure des universités, LAERO - U. Toulouse III & \normalsize Rapportrice \\
        {\large\bfseries Isabelle BRAUD},       \normalsize Directrice de Recherche, INRAE RiverLy              & \normalsize Rapportrice \\
        {\large\bfseries Jean-Louis DUFRESNE},  \normalsize Directeur de Recherche, LMD - Sorbonne U.             & \normalsize Examinateur \\
        {\large\bfseries Romain ROEHRIG},       \normalsize Chargé de Recherche, CNRM                           & \normalsize Examinateur \\
        {\large\bfseries Martin BEST},          \normalsize Research Fellow, UK Met Office                     & \normalsize Examinateur \\
        {\large\bfseries Aaron BOONE},          \normalsize Directeur de Recherche, CNRM                       & \normalsize Examinateur \\
        {\large\bfseries Agnès DUCHARNE},       \normalsize Directrice de Recherche, METIS - Sorbonne U.         & \normalsize Co-directrice de thèse \\
        {\large\bfseries Frédérique CHERUY},    \normalsize Chargée de Recherche, LMD - Sorbonne U.              & \normalsize Co-directrice de thèse \\
    \end{tabular}
    }
\end{titlepage}
