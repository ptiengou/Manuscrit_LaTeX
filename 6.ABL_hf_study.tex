...
In all the following figures, 15 July will be shown on the left and 20 July on the right. The surface conditions at La Cendrosa on these days are first compared to understand their differences (supplementary Fig. \ref{fig:iop_days_TS_surfvars_elsplans} and \ref{fig:iop_days_TS_energy_elsplans} show the same variables at Els Plans).
