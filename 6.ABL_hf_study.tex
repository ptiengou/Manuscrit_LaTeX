...
) driven by bare soil evaporation rather than plant transpiration, which is not considered realistic, but has been identified in other LSM \citep{marti_implementation_2025}. %todo:not shown ou Appendix ? ref ?
...
%todo:rrrreaaaally need soil moisture data here....
