...
%todoFC:Je me demande si tu ne peux pas  mettre des l introduction  la description de LIAISE qui est une opportunité pour analyser à fine echelle l impact de l irrigation sur la couche limite.   Ca aurait plus de consistance je pense

Considering its impacts on the energy budget at the surface, and the rapid processes at play, the effects of irrigation follow a marked diurnal cycle, with distinct nighttime and daytime effects and varying amplitude depending on insolation. 
...
\begin{itemize}
    ...
    \item Are the effects of simulated irrigation only visible over the irrigated areas or do they also affect neighbouring rain-fed areas?
...
\end{itemize}
%todoFC:il y a trop de questions à mon avis qui ont  ont des degrés d importance différents. J ai l impression que cette liste est très/trop pilotée par tes résultats.   OK pour le point 1, point 2 la premiere partie suffit. Le point 3 est dans le point 2. Dans le point 4 tu donnes (presque) déjà la réponse.  C est aussi une question reliée à l hétérogéneité ( qu il faudrait peut etre preciser). Tu devrais la combiner avec le dernier point. Je ne comprends pas bien le point 5.
...
%todoFC:est ce que le LAM presente ces caracteristiques?
...
%todoFC:ce n est plus vrai en fin de nuit.
...
%todoFC:il y a qd meme un assechement mais moins prononcé
This shows that in certain daytime conditions, increasing ET by accounting for irrigation is not sufficient to simulate a realistic 2-metre specific humidity. In particular, incorrect advection terms and surface wind can neutralise the effect of this local improvement of land-atmosphere interactions.
%todoFC:ca peut aussi venir de la parametrization de la PBL.

This hypothesis is corroborated by the 10-metre wind regime at La Cendrosa (Fig. \ref{fig:bothsites_wind}a-d), which is quite well structured in the beginning of the SOP with low wind speeds, but shows important variations in direction and an increased wind speed from 20 July. ICOLMDZOR seems to be capturing the variations quite well until 19 July but clearly misses part of the direction changes afterwards. This can clearly lead to a poor representation of advection terms over a day, failing to represent moisture inputs from the more humid Pyrenees or from the Mediterranean sea.
...
Irrigation only has an impact on the 10-metre wind speed: in \noirr it is overestimated, and that bias is partly reduced in \irr and \irrboost. This was expected since in the presence of irrigation, the vegetation is more developed and LAI is larger, leading to a larger surface drag and therefore lower surface wind speed. %todoFC surface drag tu as pu l estimer sur les simul.?
Wind direction is not impacted by irrigation (red, blue and green lines overlap in Fig. \ref{fig:bothsites_wind}d), which was also expected since only a few grid cells are intensely irrigated in the region, which limits the possibilities of influencing the dynamics of the LAM. In a zoom-nudged configuration of LMDZOR (before the introduction of the icosahedral dynamical core) over France, \citet{campoy_response_2013} had previously found that increasing soil moisture over the SIRTA observation site did not affect winds.
...
\begin{figure}[t]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 2-metre temperature\\(14-30 July - La Cendrosa)}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 2-metre specific humidity\\(14-30 July - La Cendrosa)}
...
\begin{figure}[t]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 10-metre wind speed\\(14-30 July - La Cendrosa)}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 10-metre wind direction\\(14-30 July - La Cendrosa)}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 10-metre wind speed\\(14-30 July - Els Plans)}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 10-metre wind direction\\(14-30 July - Els Plans)}
            \includegraphics[width=\textwidth]{images/chap6/SOP_TS_DC/diurnal_cycle_elsplans_wind_direction_10m.png}
        \end{subfigure}
    \end{tabular}
    \caption{Time series and mean diurnal cycle of 10-metre wind speed and direction on both sites, 14-30 July 2021. The envelope for \mesomean represents the 25th and 75th percentiles of the distribution.}
...
%todoFC:ca pourrait etre aussi que les thermiques assechent trop : As shown in the previous section on shallow convection, thermals initiating at the surface cool and dry the surface layer, warm and dry the mixed layer due to the compensating subsidence, and cool and moist the cloud layer in relation with cloud evaporation and water vapor detrainment. https://web.lmd.jussieu.fr/~hourdin/TMP/mainB.pdf
...
\begin{figure}[hbtp]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 2-metre temperature\\(14-30 July - Els Plans)}
        ...
        \end{subfigure} &
        \begin{subfigure}[t]{0.5\textwidth}
            \caption{Mean diurnal cycle of 2-metre specific humidity\\(14-30 July - Els Plans)}
            \includegraphics[width=\textwidth]{images/chap6/SOP_TS_DC/diurnal_cycle_elsplans_q2m.png}
        \end{subfigure}
    \end{tabular}
    \caption{Time series and mean diurnal cycle (14-30 July) of surface turbulent fluxes (a-d), temperature (e-f) and specific humidity (g-h) at Els Plans (rain-fed site). The envelope for \mesomean represents the 25th and 75th percentiles of the distribution.}
...
In all the following figures, 15 July will be shown on the left and 20 July on the right. The surface conditions at La Cendrosa on these days are first compared to understand their differences.
...
Supplementary figures for the Els Plans (Fig. \ref{fig:iop_days_TS_surfvars_elsplans} and \ref{fig:iop_days_TS_energy_elsplans}) also confirm the general fidelity of the Meso-NH simulation to observations on both days.
While the Meso-NH simulation started from an initial state chosen to be as realistic as possible and focused on the domain of the LIAISE study area, the ICOLMDZOR simulation setup is not particularly tuned to reflect observed synoptic conditions, only relying on the lateral boundary conditions from ERA5. Considering this, obtaining a diurnal evolution that is similar to observations (and even more to \mesomean) for most surface variables on both days is already a satisfying performance. Yet, some limitations remain that must be taken acknowledged before analysing the vertical structure of the atmosphere.
...
As previously noticed in general over the SOP, 2-metre specific humidity is overestimated by ICOLMDZOR at night, but decreases during the day, which is not very realistic at La Cendrosa. %todoFC:sauf si c est les thermiques  cette sous estimation de jour à l air tres robuste quand meme
%todoFC:tu pourrais sortir les tendances dq_the due aux thermiques si tu as le temps de relancer la simul avant la soutenance pour verifier
On 15 July, \irrboost remains slightly above observed and Meso-NH values during the day but on 20 July, daytime specific humidity is underestimated.
...
\begin{figure}[hbtp]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure} \\
    \end{tabular}
    \caption{Evolution of 2-metre temperature (a-b), 2-metre specific humidity (c-d), 10-metre wind speed (e-f) and direction (g-h) at La Cendrosa on 15 and 20 July.}
...
\begin{figure}[hbtp]
    ...
    \begin{tabular}{cc}
        ...
        \end{subfigure}
    \end{tabular}
    \caption{Evolution of surface latent (a-b) and sensible (c-d) heat fluxes, downwelling shortwave (e-f) and longwave (g-h) radiation at La Cendrosa on 15 and 20 July.}
