...
\begin{table*}[h]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        GRDC  &  River discharge & $m^3 \cdot s^{-1}$ & - & 2010-2017 & \citet{fekete_global_2003}\\
        \bottomrule
    \end{tabular}
    } %end resizebox
...
%todo:extend into perspective to improve knowledge on the LAM ?
...
%todo:finish ccl and perspectives
\clearpage
